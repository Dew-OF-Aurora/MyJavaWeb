...
import org.god.ibatis.core.ds.JNDIDataSource;
import org.god.ibatis.core.ds.PooledDataSource;
import org.god.ibatis.core.ds.UnPooledDataSource;
import org.god.ibatis.core.pojo.MappedStatement;
import org.god.ibatis.core.tr.JdbcTransaction;
import org.god.ibatis.core.tr.ManagedTransaction;
...
public class SqlSessionFactoryBuilder {
    ...
    public SqlSessionFactory build(InputStream in){
        ...
        try {
            ...
            Element transactionElt = environment.element("transactionManager");//返回事务管理器类型
