    ...
    public int insert(String sqlId, Object pojo){
        ...
        try {
            ...
            while(true){
                ...
                // 有属性名id，怎么获取id的属性值呢？反射调用getId()方法
                String getMethodName = "get" + propertyName.toUpperCase().charAt(0) + propertyName.substring(1);//生成id的get方法名
                //反射生成pojo类中存在的方法,为什么不直接使用形参pojo.getId?而是使用反射?因为不止要换取id的值还有获取别的属性值
